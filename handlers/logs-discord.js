...
// LOG_CHANNEL_ID - GANTI DENGAN ID CHANNEL LOG SERVER ANDA
...
function setupChannelLogs(client) {
...
function handleLogsDiscord(client) {
    setupMessageLogs(client);
    setupChannelLogs(client);
    setupMemberLogs(client);
    setupRoleLogs(client);
    setupVoiceLogs(client);
}

module.exports = { handleLogsDiscord };
